...
export default function Profile({ user }) {
  ...
  // Admins don't need Telegram linking
  if (user?.admin) {
    return (
      <div style={{ maxWidth: '500px', margin: '0 auto' }}>
        <div className="card">
          ...
          <p style={{ color: '#a1a1aa' }}>
            You are logged in as an <strong style={{ color: '#6366f1' }}>Admin</strong>.
            Telegram linking is only available for regular users.
          </p>
        </div>
      </div>
    );
    ...
    <div style={{ maxWidth: '500px', margin: '0 auto' }}>
      <div className="card">
        ...
        <p style={{ color: '#a1a1aa', marginBottom: '1rem' }}>
          Connect your Telegram to receive instant stock alerts.
        </p>
